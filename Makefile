...
help:
	...
	@echo "  make run-consumer    - Run the Docker container for the consumer (runs interactively)"
	@echo "  make run-consumer-detached - Run the consumer in detached mode (runs in the background)"
	@echo "  make attach-consumer-logs - Attach to the logs of the detached consumer"
	...
	@echo "  2. Run 'make run-consumer-detached' to start the consumer in the background."
	@echo "  3. Then, run either 'make run-producer' or 'make run-producer-fast' to start the producer."
	@echo "  4. Ensure your consumer application is configured to connect to your Confluent Cloud Kafka instance."
	@echo "  5. Ensure you have set up your dbt project in the '$(DBT_PROJECT_DIR)' directory."
	@echo "  6. When running dbt commands, you will be prompted to enter your GCP Project ID."
	@echo ""